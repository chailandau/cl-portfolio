        ...
        return (
            ...
            >
                <Link
                  key={menuItem.href}
                  to={menuItem.href}
                  className='font-mono text-xl tablet-lg:text-base text-blue-500! justify-between w-auto tablet-lg:justify-center text-center before:hidden tablet-lg:before:block before:w-[calc(100%-40px)] before:l-5 font-semibold'
                  onClick={handleClick}
                >
                    {menuItem.label}
                </Link>
